    ...
    <div class="container-fluid" id="jumbo">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6  box">
                <figure class="figure">
                    <img src="https://www.lg.com/global/lgwing/assets/img/phone_3.png" class="figure-img img-thumbnail img-fluid rounded" width="57%"  alt="image">
                    <figcaption class="figure-caption">
                        <center>
            ...
            <div class="col-md-3 col-sm-6  box">
                <figure class="figure">
                    <img src="https://www.setaswall.com/wp-content/uploads/2019/03/Samsung-Galaxy-A70.jpg" class="figure-img img-thumbnail img-fluid rounded" width="110%" alt="image">
                    <figcaption class="figure-caption">
                        <center>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 box">
                <figure class="figure">
                    <img src="https://rukminim1.flixcart.com/image/416/416/knyxqq80/mobile/1/u/e/a53s-5g-cph2321-oppo-original-imag2gwzmunrmur8.jpeg?q=70" class="figure-img img-thumbnail img-fluid rounded" width="70%" alt="image">
                    <figcaption class="figure-caption">
                        <center>
                            <h3>OPPO A53s</h3>
